...
# Retrieve Coordinates
    #> No tier
    execute store success score .success k.Values as @e[limit=1,type=marker,tag=kf.Collector,tag=!kf.Full,distance=..15,sort=nearest] run function kf:entities/harvester/harvesting/get_coords
