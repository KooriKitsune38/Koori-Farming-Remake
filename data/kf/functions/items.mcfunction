...
# Harvester
give @s phantom_spawn_egg{display:{Name:'{"text":"Harvester","italic":false}'},EntityTag:{id:"marker",Tags:[kf.Harvester,.temp]}}

# Collector
give @s llama_spawn_egg{display:{Name:'{"text":"Collector","italic":false}'},EntityTag:{id:"marker",Tags:[kf.Collector,.temp]}}
...
# Wind Mill
give @s ghast_spawn_egg{display:{Name:'{"text":"Wind Mill","italic":false}'},EntityTag:{id:"block_display",Rotation:[0f,0f],Tags:[kf.WindMill,.temp],block_state:{Name:"cobweb"},teleport_duration:1,transformation:{translation:[-1f,-1f,-1f],left_rotation:[0f,0f,0f,1f],scale:[2f,2f,2f],right_rotation:[0f,0f,0f,1f]}}}

# Crystalizer
give @s skeleton_spawn_egg{display:{Name:'{"text":"Crystalizer","italic":false}'},EntityTag:{id:"marker",Rotation:[0f,0f],Tags:[kf.Crystalizer,.temp,kf.RequiresPower,kf.HighUsage]}}